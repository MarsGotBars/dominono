...
export default function Card(props: cardProps) {
    ...
    return (
        <figure onClick={() => setBool(!bool)} className={classNames(bool === true ? "h-full" : "h-24", " cursor-pointer p-2 my-5 bg-gradient-to-t from-gray-300 from-5% to-white w-1/2 ")} key={key}>
